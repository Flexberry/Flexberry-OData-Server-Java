...
import org.apache.olingo.server.sample.data.StudentsDataProvider.DataProviderException;
 ...
 */
public class StudentsProcessor implements EntityCollectionProcessor, EntityProcessor,
  ...
  // database access
  public StudentsProcessor(final StudentsDataProvider dataProvider) {
  ...
  private Entity readEntityInternal(final UriInfoResource uriInfo, final EdmEntitySet entitySet)
      throws StudentsDataProvider.DataProviderException {
